...
FragTrap::FragTrap(void)
{
	...
	this->_armor_reduc = 5;
	std::cout << "Hello world! Ya rodilsya, suchen'ki(Frag)" << std::endl;
}
...
FragTrap::~FragTrap(void)
{
	std::cout << "\033[1;30m" << this->_name << "(Frag): Oh no! Is it a blood? Where is the fucking blood? Okay, even my death is so boring...\033[0m" << std::endl;
}
